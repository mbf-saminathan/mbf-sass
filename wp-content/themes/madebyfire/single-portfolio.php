...
<?php
    ...
    <div class="container">
        ...
        <div class="row border-line">
            ...
            <?php /* <div class="col-xs-8 contentCustom portfolioh1 generic <?php echo $mrg_class; ?>"> */?>
            <div class="col-xs-<?php echo $colxCls; ?> remove-padding <?php echo $mrg_class; ?> generic">
            <h1><?php echo $post->post_title; ?></h1>
                <?php
                $post_author = get_userdata($post->post_author);
                ?>
                <?php /*<div class="intro-text"><?php echo $post->post_excerpt; ?></div> */ ?>
                <?php echo apply_filters('the_content',  shortcode_empty_paragraph_fix($post->post_content)); ?>
            </div>

            <?php
            if ($dispSb == 1) {
                get_sidebar('related_link');
            } 
            ?>
