...
include('posttypes/testimonial.php');
include('posttypes/case_study.php');
include('posttypes/services.php');
include('posttypes/jobs.php');
include('posttypes/location.php');
...
include('metabox/port_cat.php');
include('metabox/short-desc.php');
include('metabox/shortcodes.php');
include('metabox/rightnav_link.php');
