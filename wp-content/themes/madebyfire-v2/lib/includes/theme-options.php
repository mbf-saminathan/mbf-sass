...
function theme_options_page() {
    if (isset($_REQUEST['submit'])) {
        ...
        update_option('appl_form_to', $_REQUEST['appl_form_to']);
        update_option('foot_loc', $_REQUEST['foot_loc']);
    ...
    <div id="usual2" class="usual"> 
        ...
        <form name="options" id="options" action="" method="post">
            ...
            <div id="tabs2" class="tab">
                ...
                <div class="contaniner">
                    <div class="label">Job application TO e-mail addresses</div>
                    <div class="field"><input type="text" name="appl_form_to" id="appl_form_to" value="<?php echo get_option('appl_form_to'); ?>" /></div>
                </div>
            </div>
            <div id="tabs3" class="tab">
            <div class="contaniner">
                        <div class="label">Footer Locations</div>
                        <div class="field"><textarea name="foot_loc" id="foot_loc"  value="" style ="width: 50%;"><?php echo get_option('foot_loc'); ?></textarea></div><br />
                    </div>
            </div>
            <br style="clear:both;" />
