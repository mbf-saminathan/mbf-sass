		<div id="homePage" class="homepage-wrapper">
 
		<header>
		<div class="container">
			<div class="logo">
				<a href="<?php echo get_site_url().'/'; ?>">
					<img src="<?php echo get_bloginfo('template_url'); ?>/images/made-by-fire-digital-agency.png" alt="Made by Fire Digital Agency UK and India">
				</a>
			</div>
			<?php
	            ...
	            <nav class="clearfix deskMenu">
					<div class="menuBlk fL">
	                    <ul class="fR clearfix">
	                        ...
	                        ?>
	                        <li><a href="<?php echo $mainMenuItem->url; ?>"><?php echo $mainMenuItem->title; ?></a></li>
	                        <?php $count++;} ?>                        
	                    </ul>
	                </div>
	            </nav>
