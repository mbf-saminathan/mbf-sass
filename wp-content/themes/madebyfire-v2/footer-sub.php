	...
	<div class="container">
		<div class="divider-line">
				...
				<div class="fL">
					...
					$footer_loc = get_option('foot_loc');
					?>
					&copy; <?php echo $year;  ?> made by fire ltd. <span class="mobRight">All rights reserved | <?php echo $footer_loc;?></span>
				</div>
		</div>
	</div>
</footer>
...
<script>
jQuery(".col-xs-2 .sticky ul li a").each(function() {
